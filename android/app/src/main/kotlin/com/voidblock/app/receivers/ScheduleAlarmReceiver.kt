...
class ScheduleAlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_START_SCHEDULE = "com.voidblock.app.START_SCHEDULE"
        const val ACTION_END_SCHEDULE = "com.voidblock.app.END_SCHEDULE"
    ...
    private fun activateSchedule(context: Context, scheduleId: Long, dayOfWeek: Int) {
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                if (dayOfWeek != -1) {
                    com.voidblock.app.utils.ScheduleManager(context)
                ...
                if (schedule != null && schedule.isActive && !schedule.isPaused) {
                    ...
                    if (blockedApps.isNotEmpty()) {
                        ...
                        // Show notification
                        com.voidblock.app.utils.NotificationHelper(context).showScheduleStartNotification(schedule.name)
                    }
