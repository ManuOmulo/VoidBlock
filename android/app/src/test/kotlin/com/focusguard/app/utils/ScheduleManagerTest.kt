...
class ScheduleManagerTest {
    ...
    fun `Monday maps to day 1`() {
        // FocusGuard uses 1-7 for Mon-Sun
        val monday = 1
        assertEquals(Calendar.MONDAY, convertFocusGuardDayToCalendar(monday))
    }

    @Test
    fun `Sunday maps to day 7`() {
        val sunday = 7
        assertEquals(Calendar.SUNDAY, convertFocusGuardDayToCalendar(sunday))
    }

    private fun convertFocusGuardDayToCalendar(focusGuardDay: Int): Int {
        // FocusGuard: 1=Mon, 2=Tue, 3=Wed, 4=Thu, 5=Fri, 6=Sat, 7=Sun
        // Calendar: 1=Sun, 2=Mon, 3=Tue, 4=Wed, 5=Thu, 6=Fri, 7=Sat
        return when (focusGuardDay) {
            1 -> Calendar.MONDAY
            2 -> Calendar.TUESDAY
